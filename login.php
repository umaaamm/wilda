...
<head>
  ...
  <title>Website Pendaftaran SMK N 1 Terusan Nyunyai | Log in</title>
...
<div class="login-box">
  ...
  <?php
        if(isset($_POST['login']))
        {
            ...
            $querylogin=$koneksi->query("select id_register,username,password from tbl_register where username='".$username."' and password='".$password."'" );
            ...
            if ($jumlah > 0)
            {
                ...
                @$_SESSION['username_r']=$data['username'];
